...
#SBATCH --output=/data/user_data/sreyasv/cartpole-sac/logs/cartpole_sac_%x_%j.out   # Stdout log
#SBATCH --error=/data/user_data/sreyasv/cartpole-sac/logs/cartpole_sac_%x_%j.err    # Stderr log
...
mkdir -p /data/user_data/sreyasv/cartpole-sac/logs/
...
export EXP=${EXP:-/data/user_data/sreyasv/dsrl_exp/logs/cartpole-sac}
