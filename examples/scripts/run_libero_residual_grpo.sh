...
#SBATCH --output=/data/user_data/skowshik/grpo_logs/logs/residual_grpo_libero_pi0_%x_%j.out   # Stdout log
#SBATCH --error=/data/user_data/skowshik/grpo_logs/logs/residual_grpo_libero_pi0_%x_%j.err    # Stderr log
...
mkdir -p /data/user_data/skowshik/grpo_logs/logs/
...
export EXP=/data/user_data/skowshik/grpo_exp/logs/$proj_name
