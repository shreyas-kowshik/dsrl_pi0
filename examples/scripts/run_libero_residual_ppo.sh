...
#SBATCH --output=/data/user_data/skowshik/qpg_logs/logs/residual_qpg_libero_pi0_%x_%j.out   # Stdout log
#SBATCH --error=/data/user_data/skowshik/qpg_logs/logs/residual_qpg_libero_pi0_%x_%j.err    # Stderr log
...
mkdir -p /data/user_data/skowshik/qpg_logs/logs/
...
export EXP=/data/user_data/skowshik/qpg_exp/logs/$proj_name
