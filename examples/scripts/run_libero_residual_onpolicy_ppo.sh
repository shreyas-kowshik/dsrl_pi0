...
#SBATCH --output=/data/user_data/skowshik/onpolicy_ppo_logs/logs/residual_onpolicy_ppo_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/onpolicy_ppo_logs/logs/residual_onpolicy_ppo_%x_%j.err
...
mkdir -p /data/user_data/skowshik/onpolicy_ppo_logs/logs/
...
export EXP=/data/user_data/skowshik/onpolicy_ppo_exp/logs/$proj_name
...
python -m examples.launch_train_sim_residual \
    ...
    --algo q_weighted_pg \
    --env libero \
    --prefix residual_onpolicy_ppo-pi05-mokaPots-4k-a-exec-norm-adv \
