...
#SBATCH --output=/data/user_data/sreyasv/cartpole-qwpg/logs/cartpole_qwpg_%x_%j.out   # Stdout log
#SBATCH --error=/data/user_data/sreyasv/cartpole-qwpg/logs/cartpole_qwpg_%x_%j.err    # Stderr log
...
mkdir -p /data/user_data/sreyasv/cartpole-qwpg/logs/
...
export EXP=${EXP:-/data/user_data/sreyasv/dsrl_exp/logs/cartpole-qwpg}
