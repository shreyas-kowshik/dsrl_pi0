#!/bin/bash
#SBATCH --job-name=rsac_no_aexec           # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/rsac_no_aexec_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/rsac_no_aexec_%x_%j.err

# =============================================================================
# LIBERO: Residual SAC — predict_a_exec=0 (actor outputs delta, not a_exec)
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_residual_sac_no_aexec.sh
# =============================================================================
...
# Configuration
# -------------------------------
proj_name=libero-residual-sac-no-aexec
device_id=0
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix rsac-no-aexec-mokaPots-4k-vlm-a-exec \
