#!/bin/bash
#SBATCH --job-name=rsac_sgd_small          # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/rsac_sgd_small_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/rsac_sgd_small_%x_%j.err

# =============================================================================
# LIBERO: Residual SAC — SGD (lr=0.001) + smaller actor MLP (256,256)
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_residual_sac_sgd_small_actor.sh
# =============================================================================
...
# Configuration
# -------------------------------
proj_name=libero-residual-sac-sgd-small-actor
device_id=0
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix rsac-sgd-small-actor-mokaPots-4k-vlm-a-exec \
