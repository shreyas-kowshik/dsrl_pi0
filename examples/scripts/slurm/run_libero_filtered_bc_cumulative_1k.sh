#!/bin/bash
#SBATCH --job-name=fbc_cumul_1k_pi05              # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/filtered_bc_cumul_1k_libero_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/filtered_bc_cumul_1k_libero_%x_%j.err

# =============================================================================
# LIBERO: Filtered Behavior Cloning with Cumulative Data (no expert) - 1k steps
# =============================================================================
#
...
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_filtered_bc_cumulative_1k.sh
# =============================================================================
...
# -------------------------------
# Launch Filtered BC Training (cumulative, no expert, 1k steps)
# -------------------------------
python -m examples.launch_train_sim_base_policy_distillation \
    --env libero \
    --prefix filtered_bc_pi05-mokaPots-cumul-1k \
