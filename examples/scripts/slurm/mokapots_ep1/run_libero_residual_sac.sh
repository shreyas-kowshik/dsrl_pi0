#!/bin/bash
#SBATCH --job-name=residual_sac_mokapots_ep1     # Job name
...
# =============================================================================
# LIBERO: Residual SAC — Mokapots ep1, 10k checkpoint
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/mokapots_ep1/run_libero_residual_sac.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix r-sac-a-exec_pi5_mokaPots-ep1-10k-vlm-embedding-bc-warmup-utd-rev \
