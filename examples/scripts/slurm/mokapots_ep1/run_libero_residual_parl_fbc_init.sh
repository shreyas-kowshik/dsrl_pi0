#!/bin/bash
#SBATCH --job-name=rparl_mokapots_ep1_fbc        # Job name
...
# =============================================================================
# LIBERO: Residual PA-RL — Mokapots ep1, FBC-initialized checkpoint (round 6)
# =============================================================================
#
...
#
# Usage:
#   sbatch examples/scripts/slurm/mokapots_ep1/run_libero_residual_parl_fbc_init.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --algo residual_parl \
    --env libero \
    --prefix residual_parl_pi05-mokaPots-ep1-fbc-round6-vlm-a-exec \
