#!/bin/bash
#SBATCH --job-name=fbc_mokapots_ep1_100t_flr1e6 # Job name
...
# =============================================================================
# LIBERO: Filtered BC — Mokapots ep1, 10k checkpoint, 100 traj/round, 20 rounds, flat LR 1e-6
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/mokapots_ep1/run_libero_filtered_bc_cumulative_w_expert_100trajectories_20rounds_flat_lr_1e-6.sh
# =============================================================================
...
python -m examples.launch_train_sim_base_policy_distillation \
    --env libero \
    --prefix filtered_bc_pi05-mokaPots-ep1-10k-cumul-expert-20rounds-100traj-flat_lr_1e-6 \
