#!/bin/bash
#SBATCH --job-name=residual_parl_mokapots_ep1   # Job name
...
# =============================================================================
# LIBERO: Residual PA-RL — Mokapots ep1, 10k checkpoint
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/mokapots_ep1/run_libero_residual_parl.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --algo residual_parl \
    --env libero \
    --prefix residual_parl_pi05-mokaPots-ep1-10k-vlm-a-exec \
