#!/bin/bash
#SBATCH --job-name=rparl_mokapots_ep1_2k         # Job name
...
# =============================================================================
# LIBERO: Residual PA-RL — Mokapots ep1, 2k checkpoint
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/mokapots_ep1/run_libero_residual_parl_ch2k.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --algo residual_parl \
    --env libero \
    --prefix residual_parl_pi05-mokaPots-ep1-2k-vlm-a-exec \
