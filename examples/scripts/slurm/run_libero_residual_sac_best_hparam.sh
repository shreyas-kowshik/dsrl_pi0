...
#SBATCH --output=/data/user_data/skowshik/r_sac_best/logs/residual_sac_libero_pi0_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/r_sac_best/logs/residual_sac_libero_pi0_%x_%j.err

# =============================================================================
# LIBERO: Residual SAC with Pi-0.5
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_residual_sac_best_hparam.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix r-sac-a-exec_pi5_2moka-pots-ckpt-vlm-embedding-bc-warmup \
    --wandb_project debug-3-libero-residual-sac-f-a \
    --seed 0 \
    --batch_size 64 \
    --discount 0.999 \
    --max_steps 1000000 \
