#!/bin/bash
#SBATCH --job-name=rsac_sgd_sm_noaex       # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/rsac_sgd_sm_noaex_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/rsac_sgd_sm_noaex_%x_%j.err

# =============================================================================
# LIBERO: Residual SAC — SGD (lr=0.001) + smaller actor MLP (256,256) + no a_exec
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_residual_sac_sgd_small_actor_no_aexec.sh
# =============================================================================
...
# Configuration
# -------------------------------
proj_name=libero-residual-sac-sgd-small-actor-no-aexec
device_id=0
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix rsac-sgd-small-noaexec-mokaPots-4k-vlm \
