#!/bin/bash
#SBATCH --job-name=residual_parl_bookcaddy_ep5   # Job name
...
# =============================================================================
# LIBERO: Residual PA-RL — Book Caddy ep5, 4k checkpoint
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/bookincaddy_ep5/run_libero_residual_parl.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --algo residual_parl \
    --env libero \
    --prefix residual_parl_pi05-bookCaddy-ep5-4k-vlm-a-exec \
