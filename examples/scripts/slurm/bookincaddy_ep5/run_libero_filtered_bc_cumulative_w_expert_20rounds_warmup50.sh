#!/bin/bash
#SBATCH --job-name=fbc_bookcaddy_ep5_20r_w50    # Job name
...
# =============================================================================
# LIBERO: Filtered BC — Book Caddy ep5, 4k checkpoint, 20 rounds, warmup 50
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/bookincaddy_ep5/run_libero_filtered_bc_cumulative_w_expert_20rounds_warmup50.sh
# =============================================================================
...
python -m examples.launch_train_sim_base_policy_distillation \
    --env libero \
    --prefix filtered_bc_pi05-bookCaddy-ep5-4k-cumul-expert-20rounds-warmup50 \
