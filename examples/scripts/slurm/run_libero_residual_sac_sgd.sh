#!/bin/bash
#SBATCH --job-name=rsac_sgd                # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/rsac_sgd_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/rsac_sgd_%x_%j.err

# =============================================================================
# LIBERO: Residual SAC — SGD optimizer for actor (lr=0.001)
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_residual_sac_sgd.sh
# =============================================================================
...
# Configuration
# -------------------------------
proj_name=libero-residual-sac-sgd
device_id=0
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix rsac-sgd-mokaPots-4k-vlm-a-exec \
