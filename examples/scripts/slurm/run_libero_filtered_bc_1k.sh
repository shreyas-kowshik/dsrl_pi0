#!/bin/bash
#SBATCH --job-name=fbc_1k_pi05                         # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/filtered_bc_1k_libero_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/filtered_bc_1k_libero_%x_%j.err

# =============================================================================
# LIBERO: Filtered Behavior Cloning (non-cumulative) - 1k steps
# =============================================================================
#
...
# Uses 1000 train steps per round and collects 50 trajectories per round.
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_filtered_bc_1k.sh
# =============================================================================
...
# -------------------------------
# Launch Filtered BC Training (non-cumulative, 1k steps)
# -------------------------------
