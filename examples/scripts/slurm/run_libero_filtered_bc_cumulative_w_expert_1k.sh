#!/bin/bash
#SBATCH --job-name=fbc_cumul_expert_1k_pi05       # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/filtered_bc_cumul_expert_1k_libero_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/filtered_bc_cumul_expert_1k_libero_%x_%j.err

# =============================================================================
# LIBERO: Filtered Behavior Cloning with Cumulative Data + Expert Demos - 1k steps
# =============================================================================
#
...
# Uses 1000 train steps per round instead of 500.
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_filtered_bc_cumulative_w_expert_1k.sh
# =============================================================================
...
# -------------------------------
# Launch Filtered BC Training (cumulative + expert data, 1k steps)
# -------------------------------
python -m examples.launch_train_sim_base_policy_distillation \
    --env libero \
    --prefix filtered_bc_pi05-mokaPots-cumul-expert-1k \
