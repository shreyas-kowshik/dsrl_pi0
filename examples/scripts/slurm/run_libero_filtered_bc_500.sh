#!/bin/bash
#SBATCH --job-name=fbc_500_pi05                        # Job name
...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/filtered_bc_500_libero_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/filtered_bc_500_libero_%x_%j.err

# =============================================================================
# LIBERO: Filtered Behavior Cloning (non-cumulative) - 500 steps
# =============================================================================
#
...
#
# Usage:
#   sbatch examples/scripts/slurm/run_libero_filtered_bc_500.sh
# =============================================================================
...
# -------------------------------
# Launch Filtered BC Training (non-cumulative, 500 steps)
# -------------------------------
python -m examples.launch_train_sim_base_policy_distillation \
    --env libero \
    --prefix filtered_bc_pi05-mokaPots-500 \
