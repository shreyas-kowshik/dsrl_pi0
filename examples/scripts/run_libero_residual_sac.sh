...
#SBATCH --output=/data/user_data/skowshik/parl_logs/logs/residual_sac_libero_pi0_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/parl_logs/logs/residual_sac_libero_pi0_%x_%j.err
...
#
# Usage:
#   bash examples/scripts/run_libero_residual_sac.sh
#   sbatch examples/scripts/run_libero_residual_sac.sh
# =============================================================================
...
python -m examples.launch_train_sim_residual \
    ...
    --env libero \
    --prefix residual_sac_pi05-mokaPots-4k-vlm-a-exec \
