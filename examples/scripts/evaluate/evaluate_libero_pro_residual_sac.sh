#!/bin/bash
#SBATCH --job-name=eval_libero_pro_residual_sac     # Job name
...
#SBATCH --output=/data/user_data/skowshik/r_sac_best/logs/eval_libero_pro_residual_sac_%x_%j.out
#SBATCH --error=/data/user_data/skowshik/r_sac_best/logs/eval_libero_pro_residual_sac_%x_%j.err

# =============================================================================
# LIBERO-PRO: Evaluate Residual SAC checkpoint with position displacement (swap)
# =============================================================================
#
# Usage:
#   sbatch examples/scripts/evaluate/evaluate_libero_pro_residual_sac.sh
#
# Runs the same checkpoint as evaluate_libero_residual_sac.sh but evaluates
# under LIBERO-PRO position displacement (--use_swap 1), which swaps the
# initial placement regions of task objects as defined in
# LIBERO-PRO/libero_ood/ood_spatial_relation.yaml.
#
...
OUTPUT_DIR=/data/user_data/skowshik/libero-pro-residual-sac-eval/r-sac-a-exec_pi5_2moka-pots-ckpt-vlm-embedding-bc-warmup_2026_02_16_18_46_11_0000--s-0/checkpoint75000/
